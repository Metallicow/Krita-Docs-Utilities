...
.. figure:: Transform_Tool_Options.PNG
   :alt: Free Transform docker 
...
perspective skewing if you hold <kbd>alt</kbd>.Holding the
<kbd>Shift</kbd> key will maintain your aspect ratio throughout the
transform.

.. figure:: Krita_transforms_free.png
...
`Video of how to use the anchor point for
resizing. <https://www.youtube.com/watch?v=grzccBVd0O8>`__
...
.. figure:: Krita_transforms_perspective.png
...
.. figure:: Transform_Tool_Options_Warp.PNG
   :alt: Warp Option

   Warp Option

.. figure:: Krita_transforms_warp.png
   :alt: Free transform in action.
...
.. figure:: Krita_transforms_cage.png
   :alt:  Transforming a straight banana to be curved with the cage tool
...
deselected together by pressing <kbd>Ctrl</kbd> before clicking nodes.
...
bounding box and scaling the same, only one presses <kbd>Ctrl</kbd>
before doing the motion.

Liquify
~~~~~~~

.. figure:: Transform_Tool_Options_Liquify.PNG
   :alt: Transform_Tool_Options_Liquify.PNG

   Transform\_Tool\_Options\_Liquify.PNG
...
|Liquefy used to turn an apple into a pear| In the options for each
brush there's:
...
.. figure:: Krita_transforms_deformvsliquefy.png
   :alt: liquefy on the left and deform brush on the right.

   liquefy on the left and deform brush on the right.

Krita also has a `deform
brush <Special:myLanguage/Krita/Manual/BrushEngines/DeformBrush>`__
...
.. figure:: Krita_transforms_recursive.png
   :alt: Recursive transform transforms all the layers in the group, so with this apple, both the line-art as the fill will be transformed.
...
<kbd>Esc</kbd> to cancel this and start a new transform.

Transformation Masks
--------------------

These allow you make non-destructive transforms, check
`here <Special:myLanguage/Transformation_Masks>`__ for more info.

Category:Toolbox

.. |Liquefy used to turn an apple into a pear| image:: Krita_transforms_liquefy.png
