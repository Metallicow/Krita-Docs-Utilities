...
space, you can change only the image colour space in <span
class=“menuchoice”>Image > Properties</span> which will leave the layers
alone. But if you want to change the color space of the file including
all the layers you can do it by going to <span class=“menuchoice”>Image
> Convert Image Color Space</span> this will will convert all the layers
Colorspace as well.
...
file:Document_Infomration.PNG

You can edit these things in <span class=“menuchoice”> File > Document
Information</span>, and for the author's information <span
class=“menuchoice”>Settings > Configure Krita > Author
Information</span>. You can switch between profiles under <span
class=“menuchoice”>Settings >Active Author Profile</span>.

Setting the canvas background color
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

You can set the canvas background color via <span
class=“menuchoice”>Image > Image Background color and
Transparency</span>. This allows you to turn the background color
...
option, or using <span class=“menuchoice”>Set Canvas Background
Color</span> in the new file options, will allow you to work in a
...
Using <span class=“menuchoice”>Image > Trim to Layer</span>, Krita
...
<span class=“menuchoice”>Image->Trim to Selection</span> is a faster
...
clicking the layer on the layer stack and choosing <span
class=“menuchoice”>Select Opaque</span>. <span class=“menuchoice”>Image
>Trim to Selection</span> will then crop the canvas to the selection
bounding box.

<span class=“menuchoice”>Image > Trim to Image Size</span> is actually
...
You can also resize the canvas via <span class=“menuchoice”>Image >
Resize Canvas</span>(or <kbd>Ctrl + Alt + C</kbd>). The dialog box is
shown below.

file:Resize_Canvas.PNG
...
.. figure:: Infinite-canvas.png
   :alt: Infinite-canvas.png
   :width: 700px
...
file:Scale_Image_to_New_Size.PNG
...
`blending
mode <Special:myLanguage/Krita/Manual/Blendingmodes#addition>`__.
...
.. raw:: mediawiki
   ...
   {{Note|Since Krita's file format is compressed data file, in case of corrupt or broken file you can open it with archive managers and extract the contents of the layers. This will help you to recover as much as possible data from the file. On windows you need to rename it to filename.zip to open it.}}
