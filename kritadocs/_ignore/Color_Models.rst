...
`thumb\|center\|500px\|In Krita, there's also the fact that the default
...
by the printing house. <File:Cmyk_black_differences.png>`__ While CMYK
has a smaller 'gamut' than RGB, however, it's still recommended to use a
