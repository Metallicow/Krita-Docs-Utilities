...
.. figure:: Krita_tablet_types.png
   :alt: Krita_tablet_types.png

   Krita\_tablet\_types.png
...
.. raw:: mediawiki
   ...
   {{Info|Sometimes, people confuse finger-touch styluses with a proper tablet. You can tell the difference because a drawing tablet stylus usually has a pointy nib, while a stylus made for finger-touch has a big rubbery round nib, like a finger. These tablets may not give good results and a pressure-sensitive tablet is recommended. [[File:Krita tablet stylus.png|center]] }}
...
.. figure:: Krita_tablet_drivermissing.png
   :alt: Krita_tablet_drivermissing.png

   Krita\_tablet\_drivermissing.png
...
will need to turn it off in the configuration.

Supported Tablets
-----------------

Supported tablets are the ones of which Krita developers have a version
themselves, so they can reliably fix bugs with them. `We maintain a list
of those here <Special:MyLanguage/List_of_Tablets_Supported>`__.
