...
PAGE_LINKS = OrderedDict([
    ...
    # - Some missing pages not in the wikitree.
    #   See: https://docs.krita.org/Special:AllPages
    ("Contributors Readme",                                         "https://docs.krita.org/index.php?title=Contributors_Readme"),
    ("List of Tablets Supported",                                   "https://docs.krita.org/index.php?title=List_of_Tablets_Supported"),
    ("Comic Workflow: Preparation and Thumbnailing",                "https://docs.krita.org/index.php?title=Comic_Workflow:_Preparation_and_Thumbnailing"),
    ("External Training and Tutorials",                             "https://docs.krita.org/index.php?title=External_Training_and_Tutorials"),

    ("Basic Concepts en-gb",                                        "https://docs.krita.org/index.php?title=Basic_Concepts/en-gb"),
    # These pages don't have an edit button, just translate.
    # ("Basic Concepts es",                                           "https://docs.krita.org/index.php?title=Basic_Concepts/es"),
    # ("Basic Concepts ko",                                           "https://docs.krita.org/index.php?title=Basic_Concepts/ko"),
    # ("Basic Concepts nl",                                           "https://docs.krita.org/index.php?title=Basic_Concepts/nl"),
    # ("Basic Concepts ru",                                           "https://docs.krita.org/index.php?title=Basic_Concepts/ru"),

    ("KritaFAQ en-gb",                                              "https://docs.krita.org/index.php?title=KritaFAQ/en-gb"),
    # These pages don't have an edit button, just translate.
    # ("KritaFAQ es",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/es"),
    # ("KritaFAQ fr",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/fr"),
    # ("KritaFAQ hi",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/hi"),
    # ("KritaFAQ ja",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/ja"),
    # ("KritaFAQ ko",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/ko"),
    # ("KritaFAQ pl",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/pl"),
    # ("KritaFAQ ru",                                                 "https://docs.krita.org/index.php?title=KritaFAQ/ru"),
...
def download_mediawiki_pages():
    ...
    for pagename, url in list(PAGE_LINKS.items()):
        ...
        if mediawiki_markup:
            # filename replaces:
            # '*' and ':' cannot be in a filename. convert to '_'
            # replace all spaces with an underscore.
            pagenamedotmediawiki = pagename.replace('*', '').replace(' ', '_').replace(':', '_') + '.mediawiki'
...
def check_what_files_didnt_pandoc_convert():
    cwd = os.path.dirname(__file__)
    for filename in os.listdir(cwd):
        if filename.endswith('.mediawiki'):
            mediawikifile = filename
            checkforrst = mediawikifile.replace('.mediawiki', '.rst')
            if not os.path.exists(checkforrst):
                print('%s NOT Found' % checkforrst)
...
if __name__ == '__main__':
    ...
    check_what_files_didnt_pandoc_convert()
        ### * Gamma_and_Linear.mediawiki
