...
# -*- coding: utf-8 -*-
#
# Krita documentation build configuration file, created by
...
project = u'Krita'
copyright = u'2017, Krita Foundation'
...
html_short_title = 'Krita Docs'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
## html_logo = None
html_logo = '_static/images/sphinxdocs/krita-logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
## html_favicon = None
html_favicon = '_static/images/sphinxdocs/krita_favicon16.png'
...
latex_documents = [
  ('index', 'Krita.tex', u'Krita Documentation',
   u'Krita Team', 'manual'),
]
...
man_pages = [
    ('index', 'krita', u'Krita Documentation',
     [u'Krita Team'], 1)
]
...
texinfo_documents = [
  ('index', 'Krita', u'Krita Documentation',
   u'Krita Team', 'Krita', 'One line description of project.',
   'Miscellaneous'),
]
